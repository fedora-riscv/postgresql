...
%global betaversion %{majorversion}beta4
...
Source1: postgresql-%{betaversion}-US.pdf
...
Source16: https://ftp.postgresql.org/pub/source/v%{betaversion}/postgresql-%{betaversion}.tar.bz2.sha256
...
%setup -q -a 12 -n postgresql-%{betaversion}
%patch1 -p1
%patch2 -p1
%patch5 -p1
%patch6 -p1
