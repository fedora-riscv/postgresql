...
Source0: https://ftp.postgresql.org/pub/source/v%{version}/postgresql-%{version}beta2.tar.bz2
...
Source16: https://ftp.postgresql.org/pub/source/v%{version}/postgresql-%{version}beta2.tar.bz2.sha256
...
%setup -q -a 12 -n postgresql-%{version}beta2
%patch1 -p1
%patch2 -p1
%patch5 -p1
%if %external_libpq
